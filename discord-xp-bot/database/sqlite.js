...
// GÜNCELLENDİ: Güvenlik kontrolü eklendi
function getLeaderboard(guildId, options = { duration: 'alltime', page: 1 }) {
  let { duration, page } = options;
  
  // GÜVENLİK YAMASI: Sayfa numarası doğrulama
  // Negatif sayılar, harfler veya 0 gelirse varsayılan olarak 1 yap.
