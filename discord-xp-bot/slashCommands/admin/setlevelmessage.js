...
module.exports = {
  ...
  async execute(interaction, client, t, db) {
    ...
    const currentMsg = guildSettings.level_up_message 
        ...
        : `_${t('setlevelmessage.default')}_`;

    // Bilgi Paneli
    const infoEmbed = new EmbedBuilder()
      .setTitle(t('setlevelmessage.title'))
      .setColor('#5865F2')
      .addFields(
        { 
          name: t('setlevelmessage.current'), 
          value: currentMsg, 
          inline: false 
        },
        { 
          name: t('setlevelmessage.variablesTitle'), 
          value: t('setlevelmessage.variablesDesc'), 
          inline: false 
        }
      );
    ...
    collector.on('collect', async (i) => {
      ...
      if (i.customId === 'lvlmsg_cancel') {
        await i.update({ 
          content: t('setlevelmessage.cancelled'), 
          embeds: [], 
          components: [] 
        });
        collector.stop();
      ...
      // 2. SIFIRLA
        ...
        await i.update({
          content: t('setlevelmessage.reset'),
          embeds: [],
          components: []
        });
        collector.stop();
      ...
      // 3. AYARLA (Mesaj Yazma Modu)
        ...
        const promptEmbed = new EmbedBuilder()
            ...
            .setDescription(`**${t('setlevelmessage.prompt')}**`)
            .addFields({
                name: t('setlevelmessage.variablesTitle'), 
                value: t('setlevelmessage.variablesDesc')
            })
        ...
        msgCollector.on('collect', async (msg) => {
          ...
          const confirmEmbed = new EmbedBuilder()
            .setColor('#E67E22')
            .setTitle(t('setlevelmessage.confirmTitle'))
            .setDescription(t('setlevelmessage.confirmDesc'))
            .addFields(
                { name: t('setlevelmessage.preview'), value: previewText },
          ...
          const saveBtn = new ButtonBuilder()
            ...
            .setLabel(t('setlevelmessage.saveButton'))
            .setStyle(ButtonStyle.Success)
            .setEmoji('💾');

          const cancelEditBtn = new ButtonBuilder()
            .setCustomId('confirm_cancel')
            .setLabel(t('setlevelmessage.cancelEditButton'))
            .setStyle(ButtonStyle.Danger)
            .setEmoji('✖️');
          ...
          confirmCollector.on('collect', async (btnI) => {
              if (btnI.customId === 'confirm_cancel') {
                  ...
                  const successEmbed = new EmbedBuilder()
                      ...
                      .setTitle(t('setlevelmessage.success'))
                      // --- GÜNCELLEME BURADA ---
